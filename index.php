...
<h1 style="color: white; margin-top:50px; font-size: 25px; height:200px; display: flex;";>Olá, sejam bem-vindos ao nosso site. Aqui você poderá desfrutar da nossa bateria "eletrônica".</h1>
<h1 style="color: white; margin-top:50px; font-size: 25px; height:200px; display: flex;";>No nosso site também tem a opção de ouvir musicas, como se fosse um spotfy. </h1>
